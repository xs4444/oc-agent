### Component Bus
![](../media/items/componentbus0.png)![](../media/items/componentbus1.png)![](../media/items/componentbus2.png)
...
![](../media/recipes/items/t1compbus.png)
...
The Component Bus (Tier 2) is crafted using the following recipe:
  ...
  * 1 x [Control Unit](materials.md)
  * 1 x [Printed Circuit Board](materials.md)
![](../media/recipes/items/t2compbus.png)
...
The Component Bus (Tier 3) is crafted using the following recipe:
  ...
  * 1 x [Control Unit](materials.md)
  * 1 x [Printed Circuit Board](materials.md)
![](../media/recipes/items/t3compbus.png)
