### CPU
![](../media/items/cpu1.png)![](../media/items/cpu2.png)![](../media/items/cpu3.png)
...
The Tier 1 CPU can support a maximum of 8 components and is crafted using the following recipe:
...
![](../media/recipes/items/t1cpu.png)

The Tier 2 CPU can support a maximum of 12 components and is crafted using the following recipe:
  * 4 x Gold nugget/oreberry (with Tinker's Construct)
  * 1 x Redstone dust
  * 1 x [Control Unit](materials.md)
  * 2 x [Microchip (Tier 2)](materials.md)
  * 1 x [Arithmetic Logic Unit](materials.md)
![](../media/recipes/items/t2cpu.png)

The Tier 3 CPU can support a maximum of 16 components and is crafted using the following recipe:
  * 4 x Diamond Chip
  * 1 x Redstone dust
  * 1 x [Control Unit](materials.md)
  * 2 x [Microchip (Tier 3)](materials.md)
  * 1 x [Arithmetic Logic Unit](materials.md)
![](../media/recipes/items/t3cpu.png)
