...
![](../media/items/wirelessnetworkcard0.png)
![](../media/items/wlan_card.png)
...
This is an upgrade to [normal network cards](lan_card.md) that allows wireless sending of network messages in addition to normal ones.
...
![](../media/recipes/items/wirelessnetworkcard.png)
