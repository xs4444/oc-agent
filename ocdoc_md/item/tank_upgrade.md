...
There are a number of methods provided in the [Robot API](../api/robot.md) that allow manipulating the fluid tanks in a similar fashion to the robot's inventory. Fluids can be sucked from or filled into tanks or the world, and can be transferred inbetween tanks, and compared against each other.
