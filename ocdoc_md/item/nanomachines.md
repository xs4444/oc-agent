...
#### Basic Usage
The player has to "eat" them before they can be used. Once ingested, a power indicator in the HUD, positioned left of the item bar, will indicate how much energy the nanomachines have left. Their energy can be recharged by standing close to a [Charger](../block/charger.md). Energy is slowly used over time proportional to the number of active inputs. A small amount of energy is still lost over time even when all inputs are deactivated.
...
To dispose of nanomachines, the player has to drink [Grog](grog.md).

#### Crafting
Nanomachines are crafted using the following recipe:
  * 4 [materials](materials.md#chamelium)
  * 1 [Wireless Network Card](wireless_network_card.md)
  * 1 [Tier 2 CPU](cpu.md)
  * 1 [Grog](grog.md)
  * 1 [Tier 1 RAM](ram.md)
  * 1 [Capacitor](../block/capacitor.md)
...
#### See also
[Nanomachines Preview](http://youtu.be/gl3zGcTh67w) (slightly outdated)
