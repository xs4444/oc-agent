# Component: Generator
This component is provided by the [generator upgrade](../item/generator_upgrade.md) for robots. Generators have an internal inventory that can store one item stack of fuel items. This API allows interaction with that inventory.
...
_"selected slot does not contain fuel"_ if the selected slot has no item which can be burnt
