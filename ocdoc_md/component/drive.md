# Component: Drive
This component is provided by [Floppy Disks](../item/floppy_disk.md) or [Hard Disk Drives](../item/hard_disk_drive.md) in Unmanaged mode (for Managed mode, see [Filesystem](filesystem.md))
