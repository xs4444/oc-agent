...
This component is provided by the [access point](../block/access_point.md) to allow computers to change the strength of the signal used to relay wireless messages.

Component name: `access_point`.
Callbacks:
