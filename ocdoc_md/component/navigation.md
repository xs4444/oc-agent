...
This is the component provided by the [Navigation Upgrade](../item/navigation_upgrade.md).
...
- `findWaypoints(range: number): table`  <u>***Note:** Requires version 1.5.9 of OpenComputers.*</u>

  Finds all [waypoint blocks](../block/waypoint.md) within the specified range.
