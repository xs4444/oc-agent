# Component: Tunnel
This component is provided by the [linked card](../item/linked_card.md).

This card is similar to the [network card's component](modem.md), but as it is only point-to-point, no ports can be configured, and the connection is always open.
