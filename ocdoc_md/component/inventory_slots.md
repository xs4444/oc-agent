...
The robot inventory, again to an external observer, is sided inventory. The robot will not share all its inventory to all sides. Slot indexes <u>do not</u> change to these different sides. Slot 1, therefore, always refers to the first toolbelt slot, even when inaccessible to a side.
