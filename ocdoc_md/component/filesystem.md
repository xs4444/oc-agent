...
This component is provided by [Floppy Disks](../item/floppy_disk.md) or [Hard Disk Drives](../item/hard_disk_drive.md) in Managed mode (for Unmanaged mode, see [Drive](drive.md))
