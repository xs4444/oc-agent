# Component API
The component API is used to access and interact with components available to a computer. Also see [the page on component interaction](../component/component_access.md).
