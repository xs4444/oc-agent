...
If enabled in the config, computers can be "owned", i.e. the list of users of a computer (see [the computer API](api/computer.md)) determines how players can interact with a computer. Specifically, only players registered as users can:
