# Capacitor
![](../media/blocks/capacitor.png)

Stores energy for later use. Can be filled and emptied very quickly. Note that some blocks have a small, internal storage capacity, to allow getting started quickly with a small setup (e.g. [computer cases](case.md) and [power converters](power_converter.md)). This means you will have to keep supplying power almost non-stop, to avoid computers shutting down due to power loss. To increase the time a network can continue to function without new power being injected into it you can build capacitors to increase the networks' energy storage capacity.
...
The Capacitor is crafted using the following recipe:
  ...
  * 1 x [Transistor](../item/materials.md)
  * 1 x [Printed Circuit Board](../item/materials.md)

![](../media/recipes/blocks/capacitor.png)
