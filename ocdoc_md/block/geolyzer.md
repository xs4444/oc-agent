# Geolyzer
![](../media/blocks/geolyzer.png)

**Provides:** [Geolyzer Component API](../component/geolyzer.md)
...
The returned values are (with some noise) the hardness values of the scanned blocks. This is useful for detecting ores (which are usually harder than stone) and for generating 'maps' that can be displayed on the [Hologram Projector](hologram_projector.md).
...
![](../media/recipes/blocks/geolyzer.png)
...
The "noise" added to scanned areas is increased based off of distance from device.
